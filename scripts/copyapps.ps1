...
start-process -FilePath "c:\apps\Git-2.16.1-64-bit" -PassThru "/SP- /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /LOG=C:\git_log.txt" -Wait
...
Start-Sleep -Seconds 15
Stop-Service -Name "AWS Agent Service" -Force
